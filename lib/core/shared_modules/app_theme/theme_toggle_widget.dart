...
import '../app_localization/when_no_localization/app_strings.dart' show AppStrings;
import '../app_localization/when_no_localization/fallback_keys.dart';
...
final class ThemeToggleIcon extends StatelessWidget {
  ...
  void _toggleTheme(BuildContext context, bool isDarkMode) {
    ...
    final message =
        isDarkMode
            ? FallbackKeysWhenNoLocalization.lightModeEnabled
            : FallbackKeysWhenNoLocalization.darkModeEnabled;
