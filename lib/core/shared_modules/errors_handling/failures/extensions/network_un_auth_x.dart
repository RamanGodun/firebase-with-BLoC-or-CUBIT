...
/// 📡 [NetworkFailure] — Specific failure for network issues (like no connection or timeout).
/// ✅ Enables custom UI actions like retry prompt
final class NetworkFailure extends Failure {
  const NetworkFailure({required String super.code, required super.message})
    : super._(statusCode: 0);
}

/// 🔐 [UnauthorizedFailure] — Unauthorized access (e.g. 401 from API).
/// ✅ Enables redirect to login, session invalidation, etc.
